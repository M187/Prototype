...
public class FirebaseHelper {
    ...
    public void makeTestData() {
        ...
        teamList.add(new Team("myTeam1", (int) (Math.random() * 30)));
        teamList.add(new Team("myTeam2", (int) (Math.random() * 30)));
        teamList.add(new Team("myTeam3", (int) (Math.random() * 30)));
        teamList.add(new Team("myTeam4", (int) (Math.random() * 30)));
        teamList.add(new Team("myTeam5", (int) (Math.random() * 30)));
        teamList.add(new Team("myTeam6", (int) (Math.random() * 30)));
        teamList.add(new Team("myTeam7", (int) (Math.random() * 30)));
        teamList.add(new Team("myTeam8", (int) (Math.random() * 30)));
