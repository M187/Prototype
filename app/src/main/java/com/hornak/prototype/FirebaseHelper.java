...
public class FirebaseHelper {
    ...
    public void makeTestData() {
        ...
        Quiz testQuiz = new Quiz("Quiz I", "07-Dec-2017", "10", "Earth", "Some fancy theme.", true, teamList);

        List<Team> teamList2 = new ArrayList<>();
        teamList2.add(new Team("myTeam1", "11"));
        teamList2.add(new Team("myTeam2", "16"));
        Quiz testQuiz2 = new Quiz("Quiz II", "03-Jan-2018", "10", "Earth", "Some fancy theme.", true, teamList2);

        List<Team> teamList3 = new ArrayList<>();
        teamList3.add(new Team("myTeam1", "4"));
        teamList3.add(new Team("myTeam2", "6"));
        Quiz testQuiz3 = new Quiz("Quiz III", "03-Jan-2018", "10", "Earth", "Some fancy theme.", false, teamList3);

        List<Team> teamList4 = new ArrayList<>();
        teamList4.add(new Team("myTeam1", "7"));
        teamList4.add(new Team("myTeam2", "12"));
        Quiz testQuiz4 = new Quiz("Quiz IV", "03-Jan-2018", "10", "Earth", "Some fancy theme.", false, teamList4);

        List<Team> teamList5 = new ArrayList<>();
        teamList5.add(new Team("myTeam1", "13"));
        teamList5.add(new Team("myTeam2", "16"));
        Quiz testQuiz5 = new Quiz("Quiz V", "03-Jan-2018", "10", "Earth", "Some fancy theme.", false, teamList5);

        List<Team> teamList6 = new ArrayList<>();
        teamList6.add(new Team("myTeam1", "11"));
        teamList6.add(new Team("myTeam2", "9"));
        Quiz testQuiz6 = new Quiz("Quiz VI", "03-Jan-2018", "10", "Earth", "Some fancy theme.", false, teamList6);
